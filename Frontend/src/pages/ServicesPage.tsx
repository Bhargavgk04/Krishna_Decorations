...
const ServicesPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(17,29,48,0.85),_rgba(5,11,22,0.95))] text-slate-100 pt-20">
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="group bg-[rgba(8,17,32,0.92)] rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-[rgba(148,163,184,0.18)] cursor-pointer"
              ...
              >
                <div className="mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-golden transition-colors duration-300">
                    {service.title}
                  </h3>
                ...
                >
                  <div className="pt-6 border-t border-[rgba(148,163,184,0.18)]">
      ...
      {/* Packages Section */}
      <section className="py-20 bg-[rgba(8,17,32,0.92)]">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className={`relative rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 bg-[rgba(8,17,32,0.92)] ${
                  pkg.popular 
                    ? 'border-golden scale-105' 
                    : 'border-[rgba(148,163,184,0.18)] hover:border-golden/50'
                }`}
              >
                {pkg.popular && (
